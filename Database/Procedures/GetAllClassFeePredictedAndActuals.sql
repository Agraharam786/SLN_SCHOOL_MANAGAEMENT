...
GO
DROP PROCEDURE IF EXISTS GetAllClassFeePredictedAndActuals
GO
CREATE PROCEDURE GetAllClassFeePredictedAndActuals
...
BEGIN
    ...
    SELECT * FROM FinalResult order by FEE_PAID_PERCENTAGE;
END;
GO
