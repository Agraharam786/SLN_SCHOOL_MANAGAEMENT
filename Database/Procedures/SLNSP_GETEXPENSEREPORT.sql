...
BEGIN
 SET NOCOUNT ON; -- Helps to reduce network traffic and improve performance
	...
	IF(@EXPENSE_TYPE <>'ALL')
		BEGIN
			SELECT ISNULL(EXPENSE_FROM,'') EXPENSE_FROM,
					EXPENSE_TYPE,				
			...
			AND IS_DELETED = 0
			GROUP BY
			EXPENSE_FROM, EXPENSE_TYPE		
			order by EXPENSE_FROM,EXPENSE_TYPE 
		END
	ELSE
		BEGIN
				SELECT ISNULL(EXPENSE_FROM,'') EXPENSE_FROM,
...
/*
	...
	exec [SLNSP_GETEXPENSEREPORT] 'ALL','2024-06-01','2024-09-01'
	exec [SLNSP_GETEXPENSEREPORT] 'Bus Maintanance','2024-08-01','2025-04-01'
