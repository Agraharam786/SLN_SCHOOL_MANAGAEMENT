...
(
	...
	CONSTRAINT PK_SLN_ADMISIONS PRIMARY KEY (ADMISION_ID,FIRST_NAME,CLASS,VILLAGE_NAME)
);
...
DROP TABLE IF EXISTS SLN_FEETYPE
CREATE TABLE dbo.SLN_FEETYPE
(
...
DROP TABLE IF EXISTS SLN_VILLAGE
CREATE TABLE dbo.SLN_VILLAGE
(
